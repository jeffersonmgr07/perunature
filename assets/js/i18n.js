...
(function () {
  const translations = {
    es: {
      ...
      "booking.paymentDetails": "Detalle estimado",
      ...
      "booking.backCatalog": "Volver al catálogo",
